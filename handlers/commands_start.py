...
async def posting():
    for chaneel in channels:
            try:
                await bot.copy_message(caption = get_caption()[0][0],from_chat_id=content_id,chat_id= chaneel,message_id = random.randint(1,643 - 1), parse_mode='html')
                await bot.copy_message(caption=get_caption2()[0][0], from_chat_id=content_id, chat_id=chaneel,message_id=random.randint(1, 643 - 1), parse_mode='html')
